    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          <h1 className="text-2xl font-bold mb-6 text-center">Admin - Ritaj</h1>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          {loading ? (
            ...
            <p className="text-center py-8 text-gray-500">Aucune réservation pour cette date</p>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Heure</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Terrain</th>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">Joueurs</th>
                ...
                <tbody className="divide-y">
                  {reservations.map(res => (
                    <tr key={res.id} className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-bold">{res.start_time}</td>
                      <td className="px-4 py-3">{res.pitches?.name}</td>
                      <td className="px-4 py-3">{res.customer_name}</td>
                      <td className="px-4 py-3">{res.phone}</td>
                      <td className="px-4 py-3">{res.players_count || '-'}</td>

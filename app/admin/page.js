          ...
          <div className="bg-white rounded-lg shadow-xl p-8 mb-8">
            <div className="space-y-4 text-left">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-900">2 terrains disponibles</h3>
                  <p className="text-gray-800">Terrain Gauche et Terrain Droit</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <span className="text-2xl mr-3">🕐</span>
                <div>
                  <h3 className="font-bold text-lg text-gray-900">Horaires flexibles</h3>
                  <p className="text-gray-800">Créneaux d'1 heure de 14h à 1h du matin</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <span className="text-2xl mr-3">💳</span>
                <div>
                  <h3 className="font-bold text-lg text-gray-900">Paiement à la caisse</h3>
                  <p className="text-gray-800">Réservez maintenant, payez sur place</p>
                </div>
              </div>
            </div>
          </div>
